...
N 0 -230 0 -210 {
lab=GND}
C {devices/code.sym} -70 20 0 0 {name=TT_MODELS
only_toplevel=true
...
C {devices/isource.sym} -300 150 0 0 {name=I0 value=5u}
C {devices/lab_pin.sym} -300 120 1 0 {name=p9 sig_type=std_logic lab=VDD}
